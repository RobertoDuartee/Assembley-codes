;
; Examen Practico 2.asm
;
; Created: 01/11/2020 11:09:49 p. m.
; Author : Roberto
;
...
main:
    ...
    SBI DDRC,0
	//Puertos de salida
	SBI DDRD, 5 //Para se�al A
	SBI DDRD, 4 //Para se�al B
	//Interrupciones externas
	LDI R16, 0b11000000
	OUT GICR, R16
	LDI R16, 0b00001010
	OUT MCUCR, R16
	//Interrupci�n Timer 0 Compare
	LDI R16, 0b00000010
	OUT TIMSK, R16
	SEI
	fin:
...
//Interrupci�n por se�al de inicio - encoder
iniciar:
	//Inicia timer
	LDI R16, 77
	OUT OCR0, R16
...
timer:
	...
	BRNE salir	//Regresa a main hasta que pasan 100ms
		...
		LDI contador, 10
		//Lee la se�al y la guarda en RAM
		IN nuevoA, PINA
		IN nuevoB, PINB
		LDS anteriorA, 0x60
		STS 0x61, anteriorA
...
//Interrupci�n por se�al de stop
stop:
	CLR R16
	OUT TCCR0, R16
	OUT TCCR1A, R16
